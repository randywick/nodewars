...
console.log('');
console.log(chalk.cyan('Nodewars 0.0.1. This software is guaranteed to contain bugs.'));
console.log('');
console.log('  Nodewars is a Node.js client for the Codewars RESTful API.');
console.log('  This program is designed to make it easier to complete Codewars');
console.log('  challenges in your IDE of choice.  Please enjoy responsibly.');
console.log('  ' + chalk.underline('https://github.com/randywick/nodewars'));
